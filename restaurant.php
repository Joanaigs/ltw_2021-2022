    ...
    <div class="filter">
        ...
        <section id="typeOfDish">
            ...
            <?php foreach ($filterTypes as $item) { ?>
                <label>
                    <input type="radio" name="typeFilter" id="<?= $idRestaurant ?>"
...
if ($session->isLoggedIn()) {
    ...
    <form action="addReview.php?idRestaurant=<?= $idRestaurant ?>" method="post" class="review"
        ...
        <p></p>
        <textarea class="form-control" rows="5" placeholder="Escreve aqui a tua review..." name="remark" id="remark"
