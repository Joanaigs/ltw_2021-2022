...
<?php function drawRegisterForm() { ?>
    <form action="register.php" method="post" class="form">
        ...
        <p>A palavra-passe deve conter no mínimo 5 caracteres e incluir letras e números</p>
        Confirme a sua palavra-passe:<input type="password" name="password_confirm" placeholder="Palavra-passe" autocomplete="off" required />
        <button type="submit" name="RegisterButton" formmethod="post">Criar conta</button>
