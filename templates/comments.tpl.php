    ...
    <section class="editReview" id="<?= $review->id ?>" style="display: none">
        <form action="../editReview.php?idReview=<?= $review->id ?>&idRestaurant=<?= $review->idRestaurant ?>" method="post"
            ...
            <div id="editRate">
                ...
                <input type="radio" id="star4<?= $review->id ?>" name="rating" value=4  <?php if ($review->rating == 4) echo "checked" ?>/>
                <label for="star4<?= $review->id ?>" title="text">4 stars</label>
                <input type="radio" id="star3<?= $review->id ?>" name="rating" value=3  <?php if ($review->rating == 3) echo "checked" ?>/>
                <label for="star3<?= $review->id ?>" title="text">3 stars</label>
                <input type="radio" id="star2<?= $review->id ?>" name="rating" value=2  <?php if ($review->rating == 2) echo "checked" ?>/>
